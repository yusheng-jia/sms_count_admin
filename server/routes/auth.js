...
function authenticateClient(req, res, next) {
  ...
  //username,user_fullname,skill_name,client_secret_key should all be present in the body
  console.log("Authenticate Client");
  db.one('select * from skills where skill_name = $1 and client_secret_key=$2', [req.body.skill_name,req.body.client_secret_key])
    .then(function (data) {
